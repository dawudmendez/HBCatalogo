            ...
            <div id="layoutSidenav_content">
                <main>                    
                    <div class="container-fluid">
                        <h1 class="mt-4">Editar Página</h1>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">    
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pag_tipo_radio" id="pag_tipo_radio_0" value="0" <?php echo ($pag->cant_prod == 0 ? "checked" : ""); ?>>
                                        <label class="form-check-label" for="pag_tipo_radio_0">Póster (sin productos)</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pag_tipo_radio" id="pag_tipo_radio_2" value="2" <?php echo ($pag->cant_prod == 2 ? "checked" : ""); ?>>
                                        <label class="form-check-label" for="pag_tipo_radio_2">2 productos</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pag_tipo_radio" id="pag_tipo_radio_4" value="4" <?php echo ($pag->cant_prod == 4 ? "checked" : ""); ?>>
                                    ...
                                    <!-- <div class="form-group form-check">
                                        <input type="checkbox" class="form-check-input" id="pag_visible" name="pag_visible" <?php echo ($pag->visible == 1 ? "checked" : ""); ?>>
